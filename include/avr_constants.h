...
#define can_msgobj_test_fl(obj,obj_fl)  (1 << MSGOBJ_##obj_fl##_b) & obj->obj_flags
#define can_msgobj_set_fl(obj,obj_fl)   obj->obj_flags |= (1 << MSGOBJ_##obj_fl##_b)
#define can_msgobj_clear_fl(obj,obj_fl) obj->obj_flags &= ~(1 << MSGOBJ_##obj_fl##_b)

#define can_msgobj_test_and_set_fl(obj,obj_fl)    test_and_set_bit(MSGOBJ_##obj_fl##_b,&(obj)->obj_flags)
#define can_msgobj_test_and_clear_fl(obj,obj_fl)  test_and_clear_bit(MSGOBJ_##obj_fl##_b,&(obj)->obj_flags)
